package zztest.http.ihttpservice;
...
//
    ...
    Call<TestPostBean> getPostBean(@Field("username") String username, @Field("password") String
            password, @Field("client") String client);
    ...
    @FormUrlEncoded
    @POST("mobile/index.php?act=login&op=index")
    Observable<TestPostBean> getPostBeanO(@Field("username") String username, @Field("password")
            String password, @Field("client") String client);
    ...
    @Multipart
    @POST("upload")
    Call<ResponseBody> uploadMultipleFiles(@Part("description") RequestBody description, @Part
            MultipartBody.Part file1, @Part MultipartBody.Part file2);

    // 上传不定数多个文件
    @Multipart
    @POST("upload")
    Call<ResponseBody> uploadMultipleFiles2(@Part("description") RequestBody description,
...
//    Observable<ResponseBody> downloadFile(@Url String fileUrl);
    ...
    Observable<ChangePwdBean> ChangePass(@Field("AccountName") String userName, @Field
            ("OriginalPass") String oldPwd,
                                         @Field("NewPass") String newPass, @Field("ComparePass")
                                                 String new2Pwd);
